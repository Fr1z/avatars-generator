...
var Tanned = makeColor('Abbronzata', '#FD9841');
var Yellow = makeColor('Itterica', '#F8D25C');
var Pale = makeColor('Pallida', '#FFDBB4');
var Light = makeColor('Chiara', '#EDB98A');
var Brown = makeColor('Scura', '#D08B5B');
var DarkBrown = makeColor('Molto Scura', '#AE5D29');
var Black = makeColor('Nera', '#614335');
